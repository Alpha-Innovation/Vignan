  ...
  return (
    <div className="privacy-modal-overlay" onClick={onClose}>
      <div className="privacy-modal-content" onClick={e => e.stopPropagation()}>
        <button className="absolute top-2 right-2 text-2xl text-gray-600 hover:text-black" onClick={onClose} aria-label="Close privacy policy">&times;</button>
        <h2 className="text-xl font-bold mb-4 text-[#0A4377]">Privacy Policy</h2>
